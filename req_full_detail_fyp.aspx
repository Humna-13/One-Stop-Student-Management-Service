<%@ Page Language="C#" AutoEventWireup="true" CodeFile="req_full_detail_fyp.aspx.cs" Inherits="req_full_detail_fyp" %>
...
<head runat="server">
    ...
    <title>FYP Manager | Request_Details</title>
<style>
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Degree</h2>
          <asp:Label ID="degree" runat="server" class="lg:w-1/2 w-full leading-relaxed text-gray-500"></asp:Label>
        </div>
      </div>
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">CGPA</h2>
          <asp:Label ID="cgpa" runat="server" class="lg:w-1/2 w-full leading-relaxed text-gray-500"></asp:Label>
        </div>
      </div>
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">FYP Start Time</h2>
          <asp:Label ID="fypstime" runat="server" class="lg:w-1/2 w-full leading-relaxed text-gray-500"></asp:Label>
        </div>
      </div>
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">FYP End Time</h2>
          <asp:Label ID="fypetime" runat="server" class="lg:w-1/2 w-full leading-relaxed text-gray-500"></asp:Label>
        </div>
      </div>
    </div>
      </div>
